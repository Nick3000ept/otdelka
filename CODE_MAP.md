...
- `budgetSSHtml` (24.08) — сводная работ СС Шамова: МОЛ · Месяцев · Ср. людей ·
  Чел.-часы · Ставка ₽/час · Стоимость (ячейки corp='СС', поля cell[9..12]); работы паркинга (corp='Паркинг') не раскрываются
...
- ~48–53 ключи кэша (`floors_v3`, `vols_v1`, `budget_v15`, `bfloors_v1`, `changes_v1`,
...
- ~818 `buildVolumes_`; ~935 `readLk_` («Личные_кабинеты» → [[МОЛ, статья,
  ...
  (Шамов)», группы = «Раздел · Вид работы» (сдельщики — раздел), ячейки по
  МОЛам, сумма в cell[5], чел.-часы/ставка/месяцы/ср.людей в cell[9..12],
